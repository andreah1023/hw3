    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="">
          <div class="mb-3">
            <label for="alNumber<?php echo $album['album_id']; ?>" class="form-label">Album number</label>
            <input type="text" class="form-control" id="alNumber<?php echo $album['album_id']; ?>" name="alNumber" value="<?php echo $album['album_number']; ?>">
          </div>
          <div class="mb-3">
